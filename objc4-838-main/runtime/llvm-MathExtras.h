...
inline unsigned CountLeadingZeros_32(unsigned int Value) {
...
inline unsigned Log2_32_Ceil(unsigned int Value) {
...
inline unsigned long long NextPowerOf2(unsigned long long A) {
  A |= (A >> 1);
  A |= (A >> 2);
  A |= (A >> 4);
  A |= (A >> 8);
